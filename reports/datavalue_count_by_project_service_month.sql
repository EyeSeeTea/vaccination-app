-- Count of datavalues and non-zero datavalues per project, service, and reporting month.
-- Measures volume of data entry work. MM/YYYY is the reporting period month.
--
...
SELECT
    ...
    COUNT(*) AS num_datavalues,
    COUNT(*) FILTER (
        WHERE
            dv.value NOT IN ('0', '0.0', '0.00')
    ) AS num_non_zero_datavalues
FROM
    datavalue dv
